...
export type introspection = {
  ...
  subscription: never;
  types: {
    'Attack': { kind: 'OBJECT'; name: 'Attack'; fields: { 'content': { name: 'content'; type: { kind: 'SCALAR'; name: 'JSONObject'; ofType: null; } }; 'damage': { name: 'damage'; type: { kind: 'SCALAR'; name: 'Int'; ofType: null; } }; 'name': { name: 'name'; type: { kind: 'SCALAR'; name: 'String'; ofType: null; } }; 'type': { name: 'type'; type: { kind: 'ENUM'; name: 'PokemonType'; ofType: null; } }; }; };
